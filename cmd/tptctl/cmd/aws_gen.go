...
var GetAwsAccountsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// get aws accounts
		v0AwsAccounts, err := client_v0.GetAwsAccounts(apiClient, apiEndpoint)
		if err != nil {
			cli.Error("failed to retrieve aws account instances", err)
			os.Exit(1)
		}

		// write the output
		if len(*v0AwsAccounts) == 0 {
			cli.Info(fmt.Sprintf(
				"No awsAccounts currently managed by %s threeport control plane",
...
var GetAwsEksKubernetesRuntimeDefinitionsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		v0AwsEksKubernetesRuntimeDefinitions, err := client_v0.GetAwsEksKubernetesRuntimeDefinitions(apiClient, apiEndpoint)
		if err != nil {
			cli.Error("failed to retrieve aws eks kubernetes runtime definition instances", err)
			os.Exit(1)
		}

		// write the output
		if len(*v0AwsEksKubernetesRuntimeDefinitions) == 0 {
			cli.Info(fmt.Sprintf(
				"No awsEksKubernetesRuntimeDefinitions currently managed by %s threeport control plane",
				requestedControlPlane,
			))
			os.Exit(0)
		}
		if err := outputGetAwsEksKubernetesRuntimeDefinitionsCmd(
			v0AwsEksKubernetesRuntimeDefinitions,
			apiClient,
			apiEndpoint,
		); err != nil {
			cli.Error("failed to produce output", err)
...
var GetAwsEksKubernetesRuntimeInstancesCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		v0AwsEksKubernetesRuntimeInstances, err := client_v0.GetAwsEksKubernetesRuntimeInstances(apiClient, apiEndpoint)
		if err != nil {
			cli.Error("failed to retrieve aws eks kubernetes runtime instance instances", err)
			os.Exit(1)
		}
		...
		if len(*v0AwsEksKubernetesRuntimeInstances) == 0 {
			cli.Info(fmt.Sprintf(
				"No awsEksKubernetesRuntimeInstances currently managed by %s threeport control plane",
				requestedControlPlane,
			))
			os.Exit(0)
		}
...
var GetAwsRelationalDatabaseDefinitionsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		v0AwsRelationalDatabaseDefinitions, err := client_v0.GetAwsRelationalDatabaseDefinitions(apiClient, apiEndpoint)
		if err != nil {
			cli.Error("failed to retrieve aws relational database definition instances", err)
			os.Exit(1)
		}

		// write the output
		if len(*v0AwsRelationalDatabaseDefinitions) == 0 {
			cli.Info(fmt.Sprintf(
				"No awsRelationalDatabaseDefinitions currently managed by %s threeport control plane",
				requestedControlPlane,
			))
			os.Exit(0)
		}
		if err := outputGetAwsRelationalDatabaseDefinitionsCmd(
			v0AwsRelationalDatabaseDefinitions,
			apiClient,
			apiEndpoint,
		); err != nil {
			cli.Error("failed to produce output", err)
...
var DescribeAwsRelationalDatabaseDefinitionCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		awsRelationalDatabaseDefinition, err := client_v0.GetAwsRelationalDatabaseDefinitionByName(
			apiClient,
			apiEndpoint,
...
var GetAwsRelationalDatabaseInstancesCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		v0AwsRelationalDatabaseInstances, err := client_v0.GetAwsRelationalDatabaseInstances(apiClient, apiEndpoint)
		if err != nil {
			cli.Error("failed to retrieve aws relational database instance instances", err)
			os.Exit(1)
		}
		...
		if len(*v0AwsRelationalDatabaseInstances) == 0 {
			cli.Info(fmt.Sprintf(
				"No awsRelationalDatabaseInstances currently managed by %s threeport control plane",
				requestedControlPlane,
			))
			os.Exit(0)
		}
...
var DescribeAwsRelationalDatabaseInstanceCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		awsRelationalDatabaseInstance, err := client_v0.GetAwsRelationalDatabaseInstanceByName(
			apiClient,
			apiEndpoint,
...
var GetAwsObjectStorageBucketDefinitionsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		v0AwsObjectStorageBucketDefinitions, err := client_v0.GetAwsObjectStorageBucketDefinitions(apiClient, apiEndpoint)
		if err != nil {
			cli.Error("failed to retrieve aws object storage bucket definition instances", err)
			os.Exit(1)
		}

		// write the output
		if len(*v0AwsObjectStorageBucketDefinitions) == 0 {
			cli.Info(fmt.Sprintf(
				"No awsObjectStorageBucketDefinitions currently managed by %s threeport control plane",
				requestedControlPlane,
			))
			os.Exit(0)
		}
		if err := outputGetAwsObjectStorageBucketDefinitionsCmd(
			v0AwsObjectStorageBucketDefinitions,
			apiClient,
			apiEndpoint,
		); err != nil {
			cli.Error("failed to produce output", err)
...
var DescribeAwsObjectStorageBucketDefinitionCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		awsObjectStorageBucketDefinition, err := client_v0.GetAwsObjectStorageBucketDefinitionByName(
			apiClient,
			apiEndpoint,
...
var GetAwsObjectStorageBucketInstancesCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		v0AwsObjectStorageBucketInstances, err := client_v0.GetAwsObjectStorageBucketInstances(apiClient, apiEndpoint)
		if err != nil {
			cli.Error("failed to retrieve aws object storage bucket instance instances", err)
			os.Exit(1)
		}
		...
		if len(*v0AwsObjectStorageBucketInstances) == 0 {
			cli.Info(fmt.Sprintf(
				"No awsObjectStorageBucketInstances currently managed by %s threeport control plane",
				requestedControlPlane,
			))
			os.Exit(0)
		}
...
var DescribeAwsObjectStorageBucketInstanceCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		awsObjectStorageBucketInstance, err := client_v0.GetAwsObjectStorageBucketInstanceByName(
			apiClient,
			apiEndpoint,
