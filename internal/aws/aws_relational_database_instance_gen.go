	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created aws relational database instance object")
					r.UnlockAndRequeue(
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated aws relational database instance object")
					r.UnlockAndRequeue(
						awsRelationalDatabaseInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted aws relational database instance object")
					r.UnlockAndRequeue(
						awsRelationalDatabaseInstance,
						requeueDelay,
						lockReleased,
