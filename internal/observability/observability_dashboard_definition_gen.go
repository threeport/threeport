	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created observability dashboard definition object")
					r.UnlockAndRequeue(
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated observability dashboard definition object")
					r.UnlockAndRequeue(
						observabilityDashboardDefinition,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted observability dashboard definition object")
					r.UnlockAndRequeue(
						observabilityDashboardDefinition,
						requeueDelay,
						lockReleased,
