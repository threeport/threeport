	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created metrics definition object")
					r.UnlockAndRequeue(
						metricsDefinition,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated metrics definition object")
					r.UnlockAndRequeue(
						metricsDefinition,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted metrics definition object")
					r.UnlockAndRequeue(
						metricsDefinition,
						requeueDelay,
						lockReleased,
