	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created logging instance object")
					r.UnlockAndRequeue(
						loggingInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated logging instance object")
					r.UnlockAndRequeue(
						loggingInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted logging instance object")
					r.UnlockAndRequeue(
						loggingInstance,
						requeueDelay,
						lockReleased,
