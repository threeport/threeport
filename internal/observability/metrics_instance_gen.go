	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created metrics instance object")
					r.UnlockAndRequeue(
						metricsInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated metrics instance object")
					r.UnlockAndRequeue(
						metricsInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted metrics instance object")
					r.UnlockAndRequeue(
						metricsInstance,
						requeueDelay,
						lockReleased,
