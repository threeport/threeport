	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created observability dashboard instance object")
					r.UnlockAndRequeue(
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated observability dashboard instance object")
					r.UnlockAndRequeue(
						observabilityDashboardInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted observability dashboard instance object")
					r.UnlockAndRequeue(
						observabilityDashboardInstance,
						requeueDelay,
						lockReleased,
