...
func LogBackendRoutes(e *echo.Echo, h *handlers.Handler) {
	e.GET("/log_backends/versions", h.GetLogBackendVersions)
...
func LogStorageDefinitionRoutes(e *echo.Echo, h *handlers.Handler) {
	e.GET("/log_storage_definitions/versions", h.GetLogStorageDefinitionVersions)
...
func LogStorageInstanceRoutes(e *echo.Echo, h *handlers.Handler) {
	e.GET("/log_storage_instances/versions", h.GetLogStorageInstanceVersions)
