	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created gateway instance object")
					r.UnlockAndRequeue(
						gatewayInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated gateway instance object")
					r.UnlockAndRequeue(
						gatewayInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted gateway instance object")
					r.UnlockAndRequeue(
						gatewayInstance,
						requeueDelay,
						lockReleased,
