	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created domain name instance object")
					r.UnlockAndRequeue(
						domainNameInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated domain name instance object")
					r.UnlockAndRequeue(
						domainNameInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted domain name instance object")
					r.UnlockAndRequeue(
						domainNameInstance,
						requeueDelay,
						lockReleased,
