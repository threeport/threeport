	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created secret instance object")
					r.UnlockAndRequeue(
						secretInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated secret instance object")
					r.UnlockAndRequeue(
						secretInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted secret instance object")
					r.UnlockAndRequeue(
						secretInstance,
						requeueDelay,
						lockReleased,
