...
func (cc *ControllerConfig) TptctlCommands() error {
	...
	commandCode.HeaderComment("generated by 'threeport-sdk codegen' for tptctl command boilerplate - do not edit")
	...
	getOutputCode.HeaderComment("originally generated by 'threeport-sdk codegen' for tptctl command scaffolding but will not be regenerated - intended for modification")
	...
	describeOutputCode.HeaderComment("originally generated by 'threeport-sdk codegen' for tptctl command scaffolding but will not be regenerated - intended for modification")
