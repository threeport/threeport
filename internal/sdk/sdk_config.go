...
type APIObject struct {
	...
	// Tptctl indicates whether tptctl commands are generated
	Tptctl *bool `yaml:"Tptctl"`

	// TptctlConfigPath indicates whether tptctl commands are generated
	TptctlConfigPath *bool `yaml:"TptctlConfigPath"`
}
