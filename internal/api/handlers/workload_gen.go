...
func (h Handler) AddWorkloadDefinition(c echo.Context) error {
	...
	// notify controller
	notifyPayload, err := workloadDefinition.NotificationPayload(false, 0, "Created")
...
func (h Handler) DeleteWorkloadDefinition(c echo.Context) error {
	...
	// notify controller
	notifyPayload, err := workloadDefinition.NotificationPayload(false, 0, "Deleted")
...
func (h Handler) AddWorkloadResourceDefinition(c echo.Context) error {
	...
	// notify controller
	notifyPayload, err := workloadResourceDefinition.NotificationPayload(false, 0, "Created")
...
func (h Handler) DeleteWorkloadResourceDefinition(c echo.Context) error {
	...
	// notify controller
	notifyPayload, err := workloadResourceDefinition.NotificationPayload(false, 0, "Deleted")
...
func (h Handler) AddWorkloadInstance(c echo.Context) error {
	...
	// notify controller
	notifyPayload, err := workloadInstance.NotificationPayload(false, 0, "Created")
...
func (h Handler) DeleteWorkloadInstance(c echo.Context) error {
	...
	// notify controller
	notifyPayload, err := workloadInstance.NotificationPayload(false, 0, "Deleted")
...
func (h Handler) AddWorkloadResourceInstance(c echo.Context) error {
	...
	// notify controller
	notifyPayload, err := workloadResourceInstance.NotificationPayload(false, 0, "Created")
...
func (h Handler) DeleteWorkloadResourceInstance(c echo.Context) error {
	...
	// notify controller
	notifyPayload, err := workloadResourceInstance.NotificationPayload(false, 0, "Deleted")
