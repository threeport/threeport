    ...
    "paths": {
        ...
        "/v0/workload-dependencies": {
            "get": {
                ...
                "operationId": "get-workloadDependencies",
                "parameters": [
                    {
                        "type": "string",
                        "description": "workload dependency search by name",
                        "name": "name",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "operationId": "add-workloadDependency",
                "parameters": [
                    {
                        "description": "WorkloadDependency object",
                        "name": "workloadDependency",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v0.WorkloadDependency"
                        }
                    }
                ],
                "responses": {
        ...
        "/v0/workload-dependencies/{id}": {
            "get": {
                ...
                "operationId": "get-workloadDependency",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID",
            ...
            "put": {
                ...
                "operationId": "replace-workloadDependency",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID",
            ...
            "delete": {
                ...
                "operationId": "delete-workloadDependency",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID",
            ...
            "patch": {
                ...
                "operationId": "update-workloadDependency",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID",
        ...
        "/workload-dependencies/versions": {
            "get": {
                ...
                "operationId": "workloadDependency-get-versions",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
        ...
        "v0.WorkloadDefinition": {
            ...
            "properties": {
                ...
                "ConsumesDependencies": {
                    "description": "ConsumesDependencies are the dependencies the infrastructure, managed\nservices, support services and workloads needed by the workload to run.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v0.WorkloadDependency"
                    }
                ...
                "ProvidesDependencies": {
                    "description": "ProvidesDependencies references dependencies the workload fulfils when\nused as a dependency by another workload.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v0.WorkloadDependency"
                    }
        ...
        "v0.WorkloadDependency": {
            ...
            "properties": {
                "ConsumingDefinitions": {
                    "description": "ConsumingDefinitions are the workload definitions that declared this\ndependency and rely upon it.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v0.WorkloadDefinition"
                    }
                ...
                "Dedicated": {
                    "description": "If true, this dependency should not be shared with other workload\ninstances.",
                    "type": "boolean"
                },
                "DependencyType": {
                    "description": "The type of dependency describes the nature of the dependency being\nmanaged for the workload.",
                    "type": "string"
                },
                "Persistent": {
                    "description": "If persistent, this dependency should remain running even when no\ninstances are consuming it.",
                    "type": "boolean"
                },
                "Providers": {
                    "description": "Providers are the workload definitions that satisfy the dependency.  Only\napplicable if the dependency is of type SupportService or Workload.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v0.WorkloadDefinition"
                    }
                ...
                "Status": {
                    "description": "The status of the dependency to expose whether it is ready and healthy.",
                    "type": "string"
                }
            }
        },
