...
func (cc *ControllerConfig) ExtensionModelVersions() error {
	f := NewFile("versions")
	f.HeaderComment("generated by 'threeport-codegen api-model' - do not edit")
	f.ImportAlias("github.com/qleet/qleetport/pkg/api-server/v0", "iapi")
	...
	for _, mc := range cc.ModelConfigs {
		...
		f.Func().Id(
			...
			Qual(
				"github.com/qleet/qleetport/pkg/api-server/v0",
				taggedFieldsMapName,
			).Index(Qual(
				"github.com/threeport/threeport/pkg/api-server/v0",
				"TagNameValidate",
