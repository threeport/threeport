...
func KubernetesRuntimeInstanceReconciler(r *controller.Reconciler) {
	...
	for {
		...
		default:
			...
			if locked || ok == false {
				r.Requeue(&kubernetesRuntimeInstance, msg.Subject, notifPayload, requeueDelay)
			...
			go func() {
				...
				case <-osSignals:
					...
					r.UnlockAndRequeue(&kubernetesRuntimeInstance, msg.Subject, notifPayload, requeueDelay, lockReleased, msg)
				case <-lockReleased:
