	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created workload definition object")
					r.UnlockAndRequeue(
						workloadDefinition,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated workload definition object")
					r.UnlockAndRequeue(
						workloadDefinition,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted workload definition object")
					r.UnlockAndRequeue(
						workloadDefinition,
						requeueDelay,
						lockReleased,
