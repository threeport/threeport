	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created kubernetes runtime instance object")
					r.UnlockAndRequeue(
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated kubernetes runtime instance object")
					r.UnlockAndRequeue(
						kubernetesRuntimeInstance,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted kubernetes runtime instance object")
					r.UnlockAndRequeue(
						kubernetesRuntimeInstance,
						requeueDelay,
						lockReleased,
