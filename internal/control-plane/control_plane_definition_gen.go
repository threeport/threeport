	...
	for {
		...
		default:
			...
			case notifications.NotificationOperationCreated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile created control plane definition object")
					r.UnlockAndRequeue(
			...
			case notifications.NotificationOperationUpdated:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile updated control plane definition object")
					r.UnlockAndRequeue(
						controlPlaneDefinition,
						requeueDelay,
						lockReleased,
			...
			case notifications.NotificationOperationDeleted:
				...
				if operationErr != nil {
					log.Error(operationErr, "failed to reconcile deleted control plane definition object")
					r.UnlockAndRequeue(
						controlPlaneDefinition,
						requeueDelay,
						lockReleased,
