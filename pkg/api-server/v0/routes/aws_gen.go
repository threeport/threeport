...
func AwsObjectStorageBucketDefinitionRoutes(e *echo.Echo, h *handlers.Handler) {
	e.GET(v0.PathAwsObjectStorageBucketDefinitionVersions, h.GetAwsObjectStorageBucketDefinitionVersions)
...
func AwsObjectStorageBucketInstanceRoutes(e *echo.Echo, h *handlers.Handler) {
	e.GET(v0.PathAwsObjectStorageBucketInstanceVersions, h.GetAwsObjectStorageBucketInstanceVersions)
...
func AwsRelationalDatabaseDefinitionRoutes(e *echo.Echo, h *handlers.Handler) {
	e.GET(v0.PathAwsRelationalDatabaseDefinitionVersions, h.GetAwsRelationalDatabaseDefinitionVersions)
...
func AwsRelationalDatabaseInstanceRoutes(e *echo.Echo, h *handlers.Handler) {
	e.GET(v0.PathAwsRelationalDatabaseInstanceVersions, h.GetAwsRelationalDatabaseInstanceVersions)
