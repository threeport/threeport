...
type HelmWorkloadDefinition struct {
	...
	ValuesDocument *string `json:"HelmValuesDocument,omitempty" query:"helmvaluesdocument" validate:"optional"`
...
type HelmWorkloadInstance struct {
	...
	ReleaseNamespace *string `json:"HelmReleaseNamespace,omitempty" query:"helmreleasenamespace" validate:"optional"`
