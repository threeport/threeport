...
type ObservabilityStackDefinition struct {
	...
	ObservabilityDashboardDefinitionID *uint `validate:"optional" relationship:"owns"`

	// The version of the grafana helm chart to use from the helm repo, e.g. 1.2.3
	GrafanaHelmChartVersion *string `validate:"optional"`

	// Optional Helm workload definition values that can be provided to configure the
	// underlying grafana chart.
	GrafanaHelmValuesDocument *string `validate:"optional"`

	// Metrics
	// The metrics definition that belongs to this resource.
	MetricsDefinitionID *uint `validate:"optional" relationship:"owns"`

	// The version of the kube-prometheus-stack helm chart to use from the helm repo, e.g. 1.2.3
	KubePrometheusStackHelmChartVersion *string `validate:"optional"`

	// Optional Helm workload definition values that can be provided to configure the
	// underlying kube-prometheus-stack chart.
	KubePrometheusStackHelmValuesDocument *string `validate:"optional"`

	// Logging
	// The logging definition that belongs to this resource.
	LoggingDefinitionID *uint `validate:"optional" relationship:"owns"`

	// The version of the loki helm chart to use from the helm repo, e.g. 1.2.3
	LokiHelmChartVersion *string `validate:"optional"`

	// Optional Helm workload definition values that can be provided to configure the
	// underlying loki chart.
	LokiHelmValuesDocument *string `validate:"optional"`

	// The version of the promtail helm chart to use from the helm repo, e.g. 1.2.3
	PromtailHelmChartVersion *string `validate:"optional"`

	// Optional Helm workload definition values that can be provided to configure the
	// underlying promtail chart.
	PromtailHelmValuesDocument *string `validate:"optional"`

	// The associated observability stack instances that are deployed from this definition.
	ObservabilityStackInstances []*ObservabilityStackInstance `validate:"optional,association"`
}
...
type ObservabilityStackInstance struct {
	...
	ObservabilityStackDefinitionID *uint `validate:"required" gorm:"not null" relationship:"requires"`
	...
	MetricsEnabled *bool `validate:"optional" gorm:"default:true"`

	// If true, logging will be enabled for the observability stack.
	LoggingEnabled *bool `validate:"optional" gorm:"default:true"`

	// Dashboard
	// The observability dashboard instance that belongs to this resource.
	ObservabilityDashboardInstanceID *uint `validate:"optional" relationship:"owns"`
	...
	MetricsInstanceID *uint `validate:"optional" relationship:"owns"`
	...
	LoggingInstanceID *uint `validate:"optional" relationship:"owns"`
...
type ObservabilityDashboardDefinition struct {
	...
	GrafanaHelmWorkloadDefinitionID *uint `validate:"optional" relationship:"owns;type:HelmWorkloadDefinition"`

	// The version of the grafana helm chart to use from the helm repo, e.g. 1.2.3
	GrafanaHelmChartVersion *string `validate:"optional" gorm:"default:'7.2.1'"`
	...
	ObservabilityDashboardInstances []*ObservabilityDashboardInstance `validate:"optional,association"`
}
...
type ObservabilityDashboardInstance struct {
	...
	// The observability dashboard definition that belongs to this resource.
	ObservabilityDashboardDefinitionID *uint `validate:"required" gorm:"not null" relationship:"requires"`
	...
	GrafanaHelmWorkloadInstanceID *uint `validate:"optional" relationship:"owns;type:HelmWorkloadInstance"`
...
type MetricsDefinition struct {
	...
	KubePrometheusStackHelmWorkloadDefinitionID *uint `validate:"optional" relationship:"owns;type:HelmWorkloadDefinition"`

	// The version of the kube-prometheus-stack helm chart to use from the helm repo, e.g. 1.2.3
	KubePrometheusStackHelmChartVersion *string `validate:"optional" gorm:"default:'55.8.1'"`
	...
	MetricsInstances []*MetricsInstance `validate:"optional,association"`
}
...
type MetricsInstance struct {
	...
	// The metrics definition that belongs to this resource.
	MetricsDefinitionID *uint `validate:"required" gorm:"not null" relationship:"requires"`
	...
	KubePrometheusStackHelmWorkloadInstanceID *uint `validate:"optional" relationship:"owns;type:HelmWorkloadInstance"`
...
type LoggingDefinition struct {
	...
	LokiHelmWorkloadDefinitionID *uint `validate:"optional" relationship:"owns;type:HelmWorkloadDefinition"`

	// The promtail Helm workload definition that belongs to this resource.
	PromtailHelmWorkloadDefinitionID *uint `validate:"optional" relationship:"owns;type:HelmWorkloadDefinition"`

	// The version of the loki helm chart to use from the helm repo, e.g. 1.2.3
	LokiHelmChartVersion *string `validate:"optional" gorm:"default:'5.41.6'"`

	// The version of the promtail helm chart to use from the helm repo, e.g. 1.2.3
	PromtailHelmChartVersion *string `validate:"optional" gorm:"default:'6.15.3'"`
	...
	LoggingInstances []*LoggingInstance `validate:"optional,association"`
}
...
type LoggingInstance struct {
	...
	// The logging definition that belongs to this resource.
	LoggingDefinitionID *uint `validate:"required" gorm:"not null" relationship:"requires"`

	// The kubernetes runtime where the logging is installed.
	KubernetesRuntimeInstanceID *uint `validate:"required" gorm:"not null" relationship:"requires"`

	// The loki helm workload instance that belongs to this resource.
	LokiHelmWorkloadInstanceID *uint `validate:"optional" relationship:"owns;type:HelmWorkloadInstance"`

	// The promtail helm workload instance that belongs to this resource.
	PromtailHelmWorkloadInstanceID *uint `validate:"optional" relationship:"owns;type:HelmWorkloadInstance"`
