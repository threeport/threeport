...
type TerraformDefinition struct {
	...
	// extension.
	ConfigDir *string `validate:"required" gorm:"not null"`

	// The associated terraform instances that are deployed from this definition.
	TerraformInstances []*TerraformInstance `validate:"optional,association"`
}
...
type TerraformInstance struct {
	...
	TerraformDefinitionID *uint `validate:"required" gorm:"not null" relationship:"requires"`
}
