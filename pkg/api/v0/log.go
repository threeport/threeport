...
type LogBackend struct {
	...
	LogStorageDefinitions []*LogStorageDefinition `validate:"optional,association" gorm:"many2many:v0_log_backends_v0_log_storage_definitions;"`
}
...
type LogStorageDefinition struct {
	...
	LogBackends []*LogBackend `validate:"optional,association" gorm:"many2many:v0_log_backends_v0_log_storage_definitions;"`

	// The associated log storage instances that are derived from this definition.
	LogStorageInstances []*LogStorageInstance `validate:"optional,association"`
}
