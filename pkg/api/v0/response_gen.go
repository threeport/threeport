...
func GetStructByObjectType(objectType ObjectType) Object {
	...
	case ObjectTypeEthereumNodeDefinition:
		objStruct = EthereumNodeDefinition{}
	case ObjectTypeEthereumNodeInstance:
		objStruct = EthereumNodeInstance{}
...
func GetObjectTypeByPath(path string) ObjectType {
	...
	case PathEthereumNodeDefinitions:
		return ObjectTypeEthereumNodeDefinition
	case PathEthereumNodeInstances:
		return ObjectTypeEthereumNodeInstance
...
func GetObjectType(v interface{}) ObjectType {
	...
	case DomainNameInstance, *DomainNameInstance, []DomainNameInstance:
		return ObjectTypeDomainNameInstance
	case EthereumNodeDefinition, *EthereumNodeDefinition, []EthereumNodeDefinition:
		return ObjectTypeEthereumNodeDefinition
	case EthereumNodeInstance, *EthereumNodeInstance, []EthereumNodeInstance:
		return ObjectTypeEthereumNodeInstance
