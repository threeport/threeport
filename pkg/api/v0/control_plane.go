...
type ControlPlaneDefinition struct {
	...
	AuthEnabled *bool `validate:"optional" gorm:"default:true"`
	...
	// a clean DB.
	OnboardParent *bool `validate:"optional" gorm:"default:true"`
...
type ControlPlaneInstance struct {
	...
	Namespace *string `validate:"required" gorm:"not null"`

	// When true, indicates the control plane instance represents the control plane in which it's stored
	IsSelf *bool `validate:"optional" gorm:"default:false"`
	...
	Parent                       *ControlPlaneInstance   `validate:"optional,association" gorm:"foreignKey:ParentControlPlaneInstanceID"`
	Children                     *[]ControlPlaneInstance `validate:"optional,association" gorm:"foreignKey:ParentControlPlaneInstanceID"`

	// The definition used to configure the control plane instance.
	ControlPlaneDefinitionID *uint `validate:"required" gorm:"not null" relationship:"requires"`
}
