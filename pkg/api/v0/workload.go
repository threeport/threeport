...
type WorkloadDefinition struct {
	...
	// ConsumesDependencies are the dependencies the infrastructure, managed
	// services, support services and workloads needed by the workload to run.
	ConsumesDependencies []*WorkloadDependency `json:"ConsumesDependencies,omitempty" query:"consumesdependencies" gorm:"many2many:consumer_definitions;" validate:"optional"`

	// ProvidesDependencies references dependencies the workload fulfils when
	// used as a dependency by another workload.
	ProvidesDependencies []*WorkloadDependency `json:"ProvidesDependencies,omitempty" query:"providesdependencies" gorm:"many2many:provider_definitions;" validate:"optional"`
...
type WorkloadInstance struct {
	...
	// ConsumesDependencies are the dependencies the infrastructure, managed
	// services, support services and workloads needed by the workload to run.
	ConsumesDependencies []*WorkloadDependency `json:"ConsumesDependencies,omitempty" query:"consumesdependencies" gorm:"many2many:consumer_instances;" validate:"optional"`
}
