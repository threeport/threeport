...
func (u *User) NotificationPayload(requeue bool, lastDelay int64, operation string) (*[]byte, error) {
...
// controller when a change is made.  It includes the object as presented by the
// client when the change was made.
func (c *Company) NotificationPayload(requeue bool, lastDelay int64, operation string) (*[]byte, error) {
	notif := notifications.Notification{
		LastRequeueDelay: &lastDelay,
		Object:           c,
		Operation:        operation,
