...
func GetWorkloadInstances(apiClient *http.Client, apiAddr string) (*[]v1.WorkloadInstance, error) {
	...
	response, err := client_lib.GetResponse(
		apiClient,
		fmt.Sprintf("%s/v1/workload-instances", apiAddr),
		http.MethodGet,
		new(bytes.Buffer),
		map[string]string{},
		http.StatusOK,
...
func GetWorkloadInstanceByID(apiClient *http.Client, apiAddr string, id uint) (*v1.WorkloadInstance, error) {
	...
	response, err := client_lib.GetResponse(
		apiClient,
		fmt.Sprintf("%s/v1/workload-instances/%d", apiAddr, id),
		http.MethodGet,
		new(bytes.Buffer),
		map[string]string{},
		http.StatusOK,
...
func GetWorkloadInstancesByQueryString(apiClient *http.Client, apiAddr string, queryString string) (*[]v1.WorkloadInstance, error) {
	...
	response, err := client_lib.GetResponse(
		apiClient,
		fmt.Sprintf("%s/v1/workload-instances?%s", apiAddr, queryString),
		http.MethodGet,
		new(bytes.Buffer),
		map[string]string{},
		http.StatusOK,
...
func GetWorkloadInstanceByName(apiClient *http.Client, apiAddr, name string) (*v1.WorkloadInstance, error) {
	...
	response, err := client_lib.GetResponse(
		apiClient,
		fmt.Sprintf("%s/v1/workload-instances?name=%s", apiAddr, name),
		http.MethodGet,
		new(bytes.Buffer),
		map[string]string{},
		http.StatusOK,
	...
	case len(workloadInstances) < 1:
		return &v1.WorkloadInstance{}, errors.New(fmt.Sprintf("no workload instance with name %s", name))
	case len(workloadInstances) > 1:
...
func UpdateWorkloadInstance(apiClient *http.Client, apiAddr string, workloadInstance *v1.WorkloadInstance) (*v1.WorkloadInstance, error) {
	...
	response, err := client_lib.GetResponse(
		apiClient,
		fmt.Sprintf("%s/v1/workload-instances/%d", apiAddr, workloadInstanceID),
		http.MethodPatch,
		bytes.NewBuffer(jsonWorkloadInstance),
		map[string]string{},
		http.StatusOK,
